...
class RecDPOTrainer(Trainer):
    ...
    def redpo_loss(
        ...
        logits_dict = {}
        for key in policy_rejected_logps:
            logits_dict[key] = (policy_rejected_logps[key] - reference_rejected_logps[key] - chosen_logratios).to(self.accelerator.device)
    ...
    def get_batch_metrics(
        ...
        if self.use_score:
            ...
            losses, chosen_rewards, rejected_rewards = self.redpo_loss(
                policy_chosen_logps,
                policy_rejected_logps,
                reference_chosen_logps,
                reference_rejected_logps,
    ...
    def compute_loss(
        ...
        if not self.use_recpo_data_collator:
            warnings.warn(
                ...
                "RecPODataCollatorWithPadding - you might see unexpected behavior. Alternatively, you can implement your own prediction_step method if you are using a custom data collator"
            )
