...
## CPO experiment
#python rec_cpo.py --prompt_path ./prompt/movie_rating2.txt  --wandb_name CPO --resume_from_checkpoint output/sft_checkpoint/ --loss_type sigmoid --cpo_alpha 1 --ln False

## SimPO Experiment
#python rec_cpo.py --prompt_path ./prompt/movie_rating2.txt  --wandb_name SimPO --resume_from_checkpoint output/sft_checkpoint/ --loss_type simpo --cpo_alpha 0 --simpo_gamma 0.5 --ln True

## CPO-SimPO experiment
#python rec_cpo.py --prompt_path ./prompt/movie_rating2.txt  --wandb_name CPO-SimPO --resume_from_checkpoint output/sft_checkpoint/ --loss_type simpo --cpo_alpha 1 --simpo_gamma 0.5 -- ln True
